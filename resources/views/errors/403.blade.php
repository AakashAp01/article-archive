...
<div class="bg-bg text-white h-screen flex flex-col items-center justify-center relative overflow-hidden selection:bg-yellow-500 selection:text-black">
    ...
    <div class="relative z-10 text-center px-6">
        ...
        <a href="{{ url()->previous() }}" class="group inline-flex items-center gap-3 border border-white/10 bg-white/5 px-8 py-4 hover:border-yellow-500 hover:bg-yellow-500/10 transition-all duration-300">
            ...
            <span class="font-display text-xs uppercase tracking-widest text-white group-hover:text-yellow-500">Go Back</span>
        </a>
    </div>
